...
import DataAccessObject.BillFileAccess;
...
public class BillController {
    ...
    private final BillFileAccess billDAO;



    public BillController(String username) {


        this.view = new BillView();
        itemDAO = new ItemFileAccess();
        billDAO = new BillFileAccess();
        this.username = username;

        ObservableList<Item> items = itemDAO.getAll();
        this.view.getTableView().setItems(items);
        ...
        view.getBtnBack().setOnAction(e -> onBackButtonPressed());
    ...
    private void setEditListeners() {
        ...
        this.view.getNrOfStockColumn().setOnEditCommit(e -> {
            itemDAO.getAll().get(e.getTablePosition().getRow()).setQuantity(e.getNewValue());
        });
    ...
    private void onCloseBill() {
        ...
        for(Item item : ItemBill)
        {
            ...
            item.setQuantity(item.getQuantity() - item.getQuantity()); // Update stock
